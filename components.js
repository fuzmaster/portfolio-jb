class SiteNav extends HTMLElement {
  connectedCallback() {
    ...
    const links = [
      ...
      { href: '/local-business-content-system.html', label: 'Services', key: 'services' },
    ...
    this.innerHTML = `
      <header class="navbar" id="navbar">
        <div class="container nav-container">
          <a href="/" class="logo" aria-label="Jacob Britten home">
          ...
          <nav aria-label="Main navigation">
            ...
            <ul class="nav-links" id="nav-links">
              ...
              <li><a class="resume-btn${current === 'resume' ? ' active' : ''}" href="/resume.html" aria-label="View interactive résumé">Résumé</a></li>
            </ul>
          </nav>
        </div>
      </header>
    ...
    this.innerHTML = `
      <footer class="footer">
        <div class="container footer-inner">
          <p>Jacob Britten — Media Producer &amp; Creative Technologist · Boston area</p>
          <div class="footer-links">
            <a href="/projects.html">Work</a>
            <a href="/lab.html">Tools</a>
            <a href="/local-business-content-system.html">Services</a>
